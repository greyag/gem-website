export const GROUPS = {
  ...
  'M3-I2': {
    ...
    hosts: 'Shasha Zou, Barbara Giles',
    blocks: ['wedAft', 'wedEve'],
    slack: 'gemworkshop.slack.com/messages/ionospheric-plasma',
  },
  IHMIC: {
  ...
  DAYS: {
    longName:
      'Dayside Kinetic Processes in Global Solar Wind- Magnetosphere Interaction (DAYS)',
    hosts:
  ...
  ML: {
    ...
    blocks: ['thursEve'],
    slack: 'gemworkshop.slack.com/messages/machine-learning',
  },
}
